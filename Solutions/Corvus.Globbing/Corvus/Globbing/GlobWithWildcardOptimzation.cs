// <copyright file="GlobWithWildcardOptimzation.cs" company="Endjin Limited">
...
namespace Corvus.Globbing
{
    ...
    /// </summary>
    public static class GlobWithWildcardOptimzation
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static bool MatchWildcardDirectoryOrdinal(ReadOnlySpan<char> glob, ReadOnlySpan<GlobToken> tokenizedGlob, int tokenIndex, ReadOnlySpan<char> value, out int charactersMatched, out int tokensConsumed)
        {
            ...
            (bool isFixedLength, int matchesMinLength) = SumMatchesMinLength(remainingPattern);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static bool MatchWildcardOrdinal(ReadOnlySpan<char> glob, ReadOnlySpan<GlobToken> tokenizedGlob, int tokenIndex, ReadOnlySpan<char> value, out int charactersMatched, out int tokensConsumed)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static (bool, int) SumMatchesMinLength(ReadOnlySpan<GlobToken> tokenizedGlob)
        {
            int accumulator = 0;
            int startIndex = 0;
            bool matchesMinLength = true;
            ...
            while (startIndex < tokenizedGlob.Length)
            {
                ...
                matchesMinLength = matchesMinLength && MatchesFixedLength(token);
            ...
            return (matchesMinLength, accumulator);
        }
