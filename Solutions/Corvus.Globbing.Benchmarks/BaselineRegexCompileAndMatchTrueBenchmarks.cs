// <copyright file="BaselineRegexCompileAndMatchTrueBenchmarks.cs" company="Endjin Limited">
...
namespace Corvus.Globbing.Benchmarks
{
    ...
    /// </summary>
    [MemoryDiagnoser]
    public class BaselineRegexCompileAndMatchTrueBenchmarks : BaseGlobBenchMark
    {
